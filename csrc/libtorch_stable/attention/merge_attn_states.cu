...
__global__ void merge_attn_states_kernel(
    ...
    const unsigned int output_head_stride, const unsigned int prefix_lse_head_stride,
    const unsigned int prefix_lse_token_stride, const unsigned int suffix_lse_head_stride,
    const unsigned int suffix_lse_token_stride, const unsigned int output_lse_head_stride,
    const unsigned int output_lse_token_stride, const unsigned int prefix_num_tokens,
...
void merge_attn_states_launcher(
  ...
  const unsigned int prefix_lse_head_stride = prefix_lse.stride(0);
  const unsigned int prefix_lse_token_stride = prefix_lse.stride(1);
  const unsigned int suffix_lse_head_stride = suffix_lse.stride(0);
  const unsigned int suffix_lse_token_stride = suffix_lse.stride(1);
  unsigned int output_lse_head_stride = 0;
  unsigned int output_lse_token_stride = 0;
