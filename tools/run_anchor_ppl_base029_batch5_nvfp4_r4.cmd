...
"G:\qwen3.8model\vllm-win029\Scripts\python.exe" "G:\qwen3.8model\vllm-030win-git\tools\anchor_ppl.py" --kv-dtype nvfp4 --max-model-len 57344 --out "G:\qwen3.8model\vllm-030win-锚点数据包\ppl_anchor_base029_batch5_nvfp4_r4.json"
