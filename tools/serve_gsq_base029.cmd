...
rem S4 finding: humming int3 kernel is NOT torch.compile-safe -- under
rem dynamo tracing humming_forward gets a non-str compute_config and
rem json.loads explodes (EngineCore failed to start). PIECEWISE boundary
rem probe is S5 scope, separately. Hence --enforce-eager for now.
