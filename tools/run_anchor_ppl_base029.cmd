@echo off
rem Anchor PPL runner on the PURE 0.29 base (no overlay) -- S1 smoke + PPL (bf16 KV).
...
"G:\qwen3.8model\vllm-win029\Scripts\python.exe" "G:\qwen3.8model\vllm-030win-git\tools\anchor_ppl.py" --kv-dtype auto --max-model-len 52288 --out "G:\qwen3.8model\vllm-030win-锚点数据包\ppl_anchor_base029.json"
